...
class StoreCandidateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'alamat_kel' => 'nullable|string|max:50',
            'alamat_kec' => 'nullable|string|max:50',
            'alamat_kota' => 'nullable|string|max:50',
            'alamat_prov' => 'nullable|string|max:50',
            'alamat_pos' => 'nullable|string|max:50',
            'telp_rumah_hp' => 'nullable|string|max:50',
            'no_ktp_sim' => 'nullable|string|max:100',
            'tgl_ktp_sim' => 'nullable|date',
            'no_npwp' => 'nullable|string|max:100',
            'alamat_npwp' => 'nullable|string|max:1000',
            'status_pajak' => 'nullable|string|max:10',
            'tax_status' => 'nullable|string|max:10',
            'marriage_status' => 'nullable|string|max:100',
            'tgl_menikah' => 'nullable|date',
            'jabatan' => 'nullable|string|max:255',
            'nama_perusahaan' => 'nullable|string|max:255',
            'alamat_perusahaan' => 'nullable|string|max:500',
            'alamat_email' => 'nullable|email|max:255',
            'tanggung_jawab' => 'nullable|string|max:100',
            'siapa_tanggungan' => 'nullable|string|max:255',
            'nilai_tanggungan' => 'nullable|string|max:255',
            'rumah_status' => 'nullable|string|max:100',
            'melanjut_pendidikan' => 'nullable|string|max:255',
            'penjelasan_pendidikan' => 'nullable|string|max:1000',
            'alasan_pekerjaan_terakhir' => 'nullable|string|max:1000',
            'uraian_pekerjaan_terakhir' => 'nullable|string|max:1000',
            ...
            'saudara_pekerjaan' => 'nullable|string|max:1000',
            'organisasi' => 'nullable|string|max:1000',
