...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'file_ktp' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_kk' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_npwp' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_sim' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_ijazah' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_skck' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_cv' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
            'file_applicant' => 'nullable|file|mimes:jpg,jpeg,png,pdf,docx|max:2048',
