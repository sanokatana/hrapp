<style>
/* Custom CSS to override default disabled input styles */
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{$contract->nama_lengkap}}"class="form-control custom-disabled" name="nama_lengkap" id="nama_lengkap"
                placeholder="Type or select employee name" autocomplete="off" disabled>
        </div>
    </div>
</div>
<div class="row">
...
<div class="row mt-3">
    ...
    <div class="col-12">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="date" value="{{$contract->end_date}}" class="form-control custom-disabled" name="end_date" id="end_date" placeholder="" disabled>
        </div>
    </div>
</div>
<div class="row">
