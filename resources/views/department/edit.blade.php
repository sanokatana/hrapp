<form action="/department/{{$department->kode_dept}}/update" method="POST" id="formDepartment">
    @csrf
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$department->nama_dept}}" class="form-control" name="nama_dept" id="nama_dept" placeholder="Information Technology">
            </div>
        </div>
    </div>
    <div class="row mt-3">
