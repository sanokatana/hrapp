<form action="/konfigurasi/libur-nasional/{{ $libur->tgl_libur }}/update" method="POST" id="formLibur">
    @csrf
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <input type="date" value="{{ $libur->tgl_libur}}" class="form-control" name="tgl_libur" id="tgl_libur" placeholder="DATE">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $libur->nama_libur}}" class="form-control" name="nama_libur" id="nama_libur" placeholder="Lebaran">
            </div>
        </div>
    </div>
    <div class="row mt-3">
