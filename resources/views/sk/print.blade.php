...
<head>
    ...
    <title>ecf6d501-8f52-4bc9-9ac9-7fc9e59da253</title>
    <meta name="author" content="PC HRD" />
    <style type="text/css">
        * {
            margin: 0;
            padding: 0;
...
<body style="margin-right: 35px;margin-left: 35px">
    <p class="s1" style="padding-top: 1pt;text-indent: 0pt;text-align: center;">INTERNAL OFFICE MEMO</p>
    ...
    <p style="padding-top: 12pt;padding-left: 7pt;text-indent: 0pt;text-align: justify;">Dengan hormat,</p>
    <p style="text-indent: 0pt;text-align: left;"><br /></p>
    <p style="padding-left: 7pt;text-indent: 0pt;text-align: justify;">Kami mohon persetujuan Bapak atas nama tersebut
        dibawah ini yang telah menyelesaikan masa percobaan. Dari hasil penilaian management atas prestasi dan kinerja
        yang diberikan selama periode tersebut layak untuk diangkat menjadi karyawan tetap.</p>
    <p style="text-indent: 0pt;text-align: left;"><br /></p>
    <p style="padding-left: 7pt;text-indent: 0pt;text-align: justify;">Nama tersebut adalah sebagai berikut:</p>
    <table style="border-collapse:collapse;margin-left:7.274pt" cellspacing="0">
        <tr style="height:45pt">
            <td
                ...
                <p class="s2"
                    style="padding-top: 8pt;padding-left: 7pt;padding-right: 6pt;text-indent: 3pt;text-align: left;">No
                    Urut</p>
            </td>
            <td
                ...
                <p style="padding-top: 2pt;text-indent: 0pt;text-align: left;"><br /></p>
                <p class="s2" style="text-indent: 0pt;text-align: center;">Nama</p>
            </td>
            <td
                ...
                <p class="s2" style="padding-top: 8pt;padding-left: 15pt;text-indent: -7pt;text-align: left;">Nama PT
                </p>
            </td>
            <td
                ...
                <p class="s2"
                    style="padding-top: 8pt;padding-left: 32pt;padding-right: 12pt;text-indent: -19pt;text-align: left;">
                    Tanggal Mulai Kerja</p>
            </td>
            <td
                ...
                <p style="padding-top: 2pt;text-indent: 0pt;text-align: left;"><br /></p>
                <p class="s2" style="padding-left: 19pt;text-indent: 0pt;text-align: left;">Jabatan</p>
            </td>
            <td
                ...
                <p style="padding-top: 2pt;text-indent: 0pt;text-align: left;"><br /></p>
                <p class="s2" style="padding-left: 21pt;text-indent: 0pt;text-align: left;">Masa Probation</p>
            </td>
        </tr>
        <tr style="height:45pt">
