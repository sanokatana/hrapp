            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <form action="/laporan/viewCutiAtasan" method="GET" autocomplete="off">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="month" value="{{ Request('bulan') }}" class="form-control" name="bulan" id="bulan" placeholder="Pilih Bulan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <table class="table table-vcenter card-table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align: center;">
                                            ...
                                            <td>{{ $d['min_time'] }} Hari</td>
                                            <td>{{ $d['avg_time'] }} Hari</td>
                                            <td>{{ $d['max_time'] }} Hari</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
