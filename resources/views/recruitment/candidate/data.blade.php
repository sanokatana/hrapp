                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $candidateData ? $candidateData->no_npwp : '' }}"
                                    class="form-control" name="no_npwp" placeholder="No. NPWP" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="alamat_npwp" rows="2" placeholder="Alamat NPWP"
                                    readonly>{{ $candidateData ? $candidateData->alamat_npwp : '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="status_pajak" id="status_pajak" disabled>
                                    ...
                                    <option value="K" {{ (isset($candidateData) && $candidateData->status_pajak == 'K') ? 'selected' : '' }}>K (Kawin)
                                    </option>
                                    <option value="K1" {{ (isset($candidateData) && $candidateData->status_pajak == 'K1') ? 'selected' : '' }}>K1</option>
                                    <option value="K2" {{ (isset($candidateData) && $candidateData->status_pajak == 'K2') ? 'selected' : '' }}>K2</option>
                                    <option value="K3" {{ (isset($candidateData) && $candidateData->status_pajak == 'K3') ? 'selected' : '' }}>K3</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="marriage_status" id="marriage_status" disabled>
                                    <option value="">Pilih</option>
                                    <option value="Menikah" {{ (isset($candidateData) && $candidateData->marriage_status == 'Menikah') ? 'selected' : '' }}>Menikah</option>
                                    <option value="Tidak Menikah" {{ (isset($candidateData) && $candidateData->marriage_status == 'Tidak Menikah') ? 'selected' : '' }}>Tidak Menikah</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="date" value="{{ $candidateData ? $candidateData->tgl_menikah : '' }}"
                                    class="form-control" name="tgl_menikah" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $candidateData ? $candidateData->jabatan : '' }}"
                                    class="form-control" name="jabatan" placeholder="Jabatan saat ini" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="text"
                                    value="{{ $candidateData ? $candidateData->nama_perusahaan : '' }}"
                                    class="form-control" name="nama_perusahaan" placeholder="Nama Perusahaan"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="alamat_perusahaan" rows="2"
                                    placeholder="Alamat Perusahaan"
                                    readonly>{{ $candidateData ? $candidateData->alamat_perusahaan : '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            <label class="col-md-5 col-form-label">Apakah Saudara mempunyai tanggung jawab lain
                                selain anak & istri ?</label>
                            <div class="col-md-7">
                                <select class="form-select" name="tanggung_jawab" id="tanggung_jawab" disabled>
                                    <option value="">Pilih</option>
                                    <option value="Ya" {{ (isset($candidateData) && $candidateData->tanggung_jawab == 'Ya') ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ (isset($candidateData) && $candidateData->tanggung_jawab == 'Tidak') ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>
                        </div>

                        <!-- Siapa dan Berapa Tanggungan Fields -->
                        <div id="additional_tanggungan">
                            <div class="row mb-3 align-items-center">
                                <label class="col-md-5 col-form-label">Siapa dan berapa besar tanggungan?</label>
                                <div class="col-md-7">
                                    <input type="text"
                                        value="{{ $candidateData ? $candidateData->siapa_tanggungan : '' }}"
                                        class="form-control" name="siapa_tanggungan" placeholder="" readonly>
                                    <input type="number"
                                        value="{{ $candidateData ? $candidateData->nilai_tanggungan : '' }}"
                                        class="form-control mt-2" name="nilai_tanggungan" placeholder="" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Status Rumah -->
                        <div class="row mb-3 align-items-center">
                            <label class="col-md-5 col-form-label">Apakah rumah status yang Saudara tempati saat
                                ini:</label>
                            <div class="col-md-7">
                                <select class="form-select" name="rumah_status">
                                    <option value="">Pilih</option>
                                    <option value="Rumah Pribadi" {{ (isset($candidateData) && $candidateData->rumah_status == 'Rumah Pribadi') ? 'selected' : '' }}>Rumah
                                        Pribadi</option>
                                    <option value="Orang Tua" {{ (isset($candidateData) && $candidateData->rumah_status == 'Orang Tua') ? 'selected' : '' }}>Orang Tua
                                    </option>
                                    <option value="Kontrak" {{ (isset($candidateData) && $candidateData->rumah_status == 'Kontrak') ? 'selected' : '' }}>Kontrak
                                    </option>
                                    <option value="Lain-lain" {{ (isset($candidateData) && $candidateData->rumah_status == 'Lain-lain') ? 'selected' : '' }}>Lain-lain
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <!-- Alasan Pekerjaan -->
                        <div class="row mb-3 align-items-center">
                            <label class="col-md-12 col-form-label">Selain untuk meningkatkan karir dan pendapatan,
                                sebutkan alasan saudara meninggalkan pekerjaan terakhir:</label>
                            <div class="col-md-12">
                                <textarea class="form-control" name="alasan_pekerjaan_terakhir" rows="2"
                                    placeholder=""
                                    readonly>{{ $candidateData ? $candidateData->alasan_pekerjaan_terakhir : '' }}</textarea>
                            </div>
                        </div>

                        <div class="row mb-3 align-items-center">
                            <label class="col-md-12 col-form-label">Berilah uraian pekerjaan dari jabatan
                                terakhir</label>
                            <div class="col-md-12">
                                <textarea class="form-control" name="uraian_pekerjaan_terakhir" rows="2"
                                    placeholder=""
                                    readonly>{{ $candidateData ? $candidateData->uraian_pekerjaan_terakhir : '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            <label class="col-md-5 col-form-label">1. Apakah Saudara bersedia menjalani masa
                                percobaan</label>
                            <div class="col-md-7">
                                <select class="form-select" name="masa_percobaan" disabled>
                                    <option value="Ya" {{ (isset($candidateData) && $candidateData->masa_percobaan == 'Ya') ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ (isset($candidateData) && $candidateData->masa_percobaan == 'Tidak') ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            <label class="col-md-5 col-form-label">2. Bersediakan saudara untuk mengikuti proses BI
                                Checking bersama CHL Group?</label>
                            <div class="col-md-7">
                                <select class="form-select" name="proses_bi" disabled>
                                    <option value="Ya" {{ (isset($candidateData) && $candidateData->proses_bi == 'Ya') ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ (isset($candidateData) && $candidateData->proses_bi == 'Tidak') ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
