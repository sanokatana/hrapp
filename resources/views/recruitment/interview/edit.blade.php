<form action="/recruitment/interview/{{ $interview->id }}/update" method="POST" id="interviewForm">
    @csrf
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <input type="date" value="{{ $interview->interview_date }}" class="form-control" name="interview_date" id="interview_date" placeholder="Officer">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <input type="time" value="{{ $interview->interview_time }}" class="form-control" name="interview_time" id="interview_time" placeholder="Officer">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $interview->notes }}" class="form-control" name="notes" id="notes" placeholder="Note">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                <input type="text" value="{{ $interview->interviewer }}" class="form-control" name="interviewer" id="interviewer" placeholder="Interviewer">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3">
                ...
                <option {{ $interview->status == 'Unscheduled' ? 'selected' : '' }} value="Unscheduled">Unscheduled</option>
                <option {{ $interview->status == 'Scheduled' ? 'selected' : '' }} value="Scheduled">Scheduled</option>
                <option {{ $interview->status == 'Completed' ? 'selected' : '' }} value="Completed">Completed</option>
            </select>
            </div>
        </div>
    </div>
